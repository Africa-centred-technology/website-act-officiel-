...
```bash
python skills/claude-skills-main/engineering/autoresearch-agent/scripts/log_results.py --experiment {domain}/{name}
```
...
```bash
python skills/claude-skills-main/engineering/autoresearch-agent/scripts/log_results.py --domain {domain}
```

### Full dashboard

```bash
python skills/claude-skills-main/engineering/autoresearch-agent/scripts/log_results.py --dashboard
```
...
```bash
# CSV
python skills/claude-skills-main/engineering/autoresearch-agent/scripts/log_results.py --dashboard --format csv --output {file}

# Markdown
python skills/claude-skills-main/engineering/autoresearch-agent/scripts/log_results.py --dashboard --format markdown --output {file}
```
