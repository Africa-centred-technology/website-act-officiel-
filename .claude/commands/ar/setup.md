...
```bash
python skills/claude-skills-main/engineering/autoresearch-agent/scripts/setup_experiment.py \
...
Then run the setup script with the collected parameters.

### Listing

```bash
# Show existing experiments
python skills/claude-skills-main/engineering/autoresearch-agent/scripts/setup_experiment.py --list

# Show available evaluators
python skills/claude-skills-main/engineering/autoresearch-agent/scripts/setup_experiment.py --list-evaluators
```
