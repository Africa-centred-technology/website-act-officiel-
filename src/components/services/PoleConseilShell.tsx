...
function HeroSection({ svc, index }: { svc: Service; index: number }) {
  const t = useTranslations("services.poles.conseil");
...
/* ═══════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════ */
const BENEFIT_ICONS = [
  "M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z M12 15a3 3 0 100-6 3 3 0 000 6z", // Eye/Vision
  "M23 6l-9.5 9.5-5-5L1 18 M23 6h-6 M23 6v6", // Trending Up
  "M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2 M9 7a4 4 0 100-8 4 4 0 000 8z", // Users
