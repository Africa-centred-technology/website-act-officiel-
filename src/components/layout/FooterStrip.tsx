  ...
  return (
    ...
    >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "4rem", marginBottom: "2.8rem" }}>
        ...
        {/* Col 1 — Contact */}
        <div>
          <p style={{ fontFamily: "Futura, system-ui, sans-serif", fontSize: "clamp(1rem, 1.4vw, 1.4rem)", letterSpacing: "0.25em", textTransform: "uppercase", fontWeight: 900, color: "#ffffff", marginBottom: "1.6rem", opacity: 0.9 }}>
            Contact
          </p>
          <div style={{ display: "flex", flexDirection: "column", gap: "0.8rem" }}>
            <a href="mailto:contact@act.africa"
              style={{ display: "flex", alignItems: "center", gap: "0.6rem", color: "#ffffff", textDecoration: "none", fontSize: "clamp(1.1rem, 1.5vw, 1.5rem)", transition: "color 0.2s", opacity: 0.85 }}
            ...
            <span style={{ display: "flex", alignItems: "center", gap: "0.6rem", color: "#ffffff", fontSize: "clamp(1.1rem, 1.5vw, 1.5rem)", opacity: 0.7 }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.4rem" }}>
          <div>
            <p style={{ fontFamily: "Futura, system-ui, sans-serif", fontSize: "clamp(1rem, 1.4vw, 1.4rem)", letterSpacing: "0.25em", textTransform: "uppercase", fontWeight: 900, color: "#ffffff", marginBottom: "1.2rem", opacity: 0.9 }}>
              Carrières
            </p>
            <p style={{ color: "#ffffff", fontSize: "clamp(1.1rem, 1.5vw, 1.5rem)", lineHeight: 1.55, marginBottom: "0.9rem", maxWidth: "300px", opacity: 0.85 }}>
              Rejoignez l&apos;équipe qui construit l&apos;Afrique technologique de demain.
            </p>
            <Link href="/careers"
              style={{ color: ORANGE, textDecoration: "none", fontSize: "clamp(1rem, 1.3vw, 1.3rem)", letterSpacing: "0.08em", textTransform: "uppercase", transition: "color 0.2s" }}
          ...
          <Link href="/contact" className="cta-btn" style={{ marginTop: "0.4rem" }}>
            <div className="cta-btn__border" /><div className="cta-btn__blur" /><div className="cta-btn__background" />
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "0.8rem" }}>
        <span style={{ color: "#ffffff", textTransform: "uppercase", fontSize: "clamp(0.9rem, 1.2vw, 1.2rem)", letterSpacing: "0.08em", opacity: 0.7 }}>
          © 2026 Africa Centred Technology. Tous droits réservés
        </span>
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          <Link href="/privacy" style={{ color: "#ffffff", textDecoration: "none", fontSize: "clamp(0.9rem, 1.2vw, 1.2rem)", textTransform: "uppercase", transition: "color 0.2s", opacity: 0.7 }}>
            Politique de Confidentialité
          </Link>
          <span style={{ color: "#ffffff", opacity: 0.4 }}>/</span>
          <Link href="/terms" style={{ color: "#ffffff", textDecoration: "none", fontSize: "clamp(0.9rem, 1.2vw, 1.2rem)", textTransform: "uppercase", transition: "color 0.2s", opacity: 0.7 }}>
            CGU
          </Link>
        </div>
      </div>
