# Claude Code — Niveau Débutant : Prendre en main l'assistant IA pour développeurs
...
- Être à l'aise avec un terminal et les commandes de base
- Avoir un compte Anthropic (Claude Pro ou Max) ou un accès API
...
### Module 1 — Comprendre Claude Code avant de l'utiliser (1h)
...
### Module 2 — Installation et configuration (1h)
...
### Module 3 — Les premières interactions (1h30)
...
### Module 4 — Configurer son projet avec CLAUDE.md (1h)
...
### Module 5 — Déléguer ses premières tâches concrètes (2h)
...
### Module 6 — Valider et garder le contrôle (30min)
...
Formation 100% pratique. Chaque participant travaille sur son propre projet ou sur un projet fourni. Démonstrations en direct suivies d'ateliers immédiats. Pas de slides — on est dans le terminal et l'éditeur du début à la fin.
